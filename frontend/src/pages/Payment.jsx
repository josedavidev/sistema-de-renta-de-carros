...
import { createReserva } from "../services/reservations.api";
import { createPayment, createInvoice } from "../services/payments.api";
    ...
    <div>
      ...
      <div>
        <div>
          ...
          <p>Número de Licencia: {reserva.license_number}</p>
          <p>País de Emisión: {reserva.license_country}</p>
        </div>
      ...
      <button onClick={handleSimularPago}>Confirmar y Pagar</button>
    </div>
  );
}
